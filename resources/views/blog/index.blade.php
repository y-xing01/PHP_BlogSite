...
@section('content')
    ...
    @foreach ($posts as $post)
        <div class="sm:grid grid-cols-2 gap-20 w-4/5 h-4/5 mx-auto py-15 border-b border-gray-200">
            <div class="h-96">
            ...
            <div>
                ...
                <p class="text-xl text-gray-700 pt-8 pb-10 leading-8 font-light truncate h-4/6 ">
                    {{ $post->description }}
                </p>
